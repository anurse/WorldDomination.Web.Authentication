...
namespace WorldDomination.Web.Authentication.Csrf
{
    public class AntiForgery : IAntiForgery
    {
        ...
        public virtual string DefaultCookieName { get { return "__WorldDomination.Web.Authentication.Mvc.CsrfToken"; } }
        ...
        protected virtual void SelectTokens(string keptToken, string recievedToken, out string pureToken, out string tokenWithExtraData)
        {
